...
with st.sidebar:
    ...
    **RANTAI INDUSTRIX** dibuat untuk memberikan pengalaman belajar interaktif bagi mahasiswa manajemen industri. Dengan modul terstruktur, kuis, dan forum kolaboratif, platform ini membantu mahasiswa:
    ...
    - Melacak perkembangan belajar secara personal.
    
    - Berinteraksi dan berdiskusi dengan sesama mahasiswa.
   
    ---
    #### 🔮 Vision Statement
    
    Visi kami adalah mencetak generasi profesional industri yang siap pakai melalui platform belajar yang interaktif, menyenangkan, dan kolaboratif
    ...
    - ⭐ **Star / Fork**: [GitHub repo](https://github.com/mrbrightsides/rantai-industrix)
...
# URL Ohara
iframe_url = "https://ohara.ai/mini-apps/f10fd74e-44f8-43b4-95c1-9c5d53761cfc"
